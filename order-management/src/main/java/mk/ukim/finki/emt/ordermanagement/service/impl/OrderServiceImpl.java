...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderId placeOrder(OrderForm orderForm) {
        ...
        newOrder.getOrderItemList().forEach(item->domainEventPublisher.publish(new OrderItemCreated(item.getProductId(),item.getQuantity())));
    ...
    public void addItem(OrderId orderId, OrderItemForm orderItemForm) throws OrderIdNotExistException {
        ...
        domainEventPublisher.publish(new OrderItemCreated(orderItemForm.getProduct().getGameId(),orderItemForm.getQuantity()));
    }
